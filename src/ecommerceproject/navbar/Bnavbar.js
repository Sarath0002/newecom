...
function Bnavbar() {
  ...
  // console.log("cartitem", cartitem.data.length);
  return (
    <>
      <Navbar className="sticky-top back ">
        <img
          src={logo}
          className="logo"
        ...
        <div className="  toglediv">
          ...
          {/* <span style={{ color: "red" }}>{cartitem.data.length}</span> */}

          <Dropdown className="seti">
            <Dropdown.Toggle variant="#346667" className="set">
              <AiTwotoneSetting className="togle seting " />
            </Dropdown.Toggle>
